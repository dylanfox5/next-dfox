...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4 text-neutral-800 dark:text-neutral-200">
        {`In August of 2025, I left to pursue my MDiv degree at Midwestern Baptist Theological Seminary where I study Greek & Hebrew. I work as a Pastoral Assistant
